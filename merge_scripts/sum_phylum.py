...
#sample_df.columns=['phylum' , 'NumReads']
new_df=sample_df[["phylum","NumReads"]].copy()
...
#
sum_df=new_df.groupby(['phylum'])['NumReads'].sum('sum').reset_index()
