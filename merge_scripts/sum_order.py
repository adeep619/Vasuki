...
#sample_df.columns=['order' , 'NumReads']
new_df=sample_df[["order","NumReads"]].copy()
...
#
sum_df=new_df.groupby(['order'])['NumReads'].sum('sum').reset_index()
