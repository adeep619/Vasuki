...
#sample_df.columns=['pathway' , 'NumReads']
new_df=sample_df[["pathway","NumReads"]].copy()
...
#
sum_df=new_df.groupby(['pathway'])['NumReads'].sum('sum').reset_index()
