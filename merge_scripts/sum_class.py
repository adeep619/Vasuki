...
#sample_df.columns=['class' , 'NumReads']
new_df=sample_df[["class","NumReads"]].copy()
...
#
sum_df=new_df.groupby(['class'])['NumReads'].sum('sum').reset_index()
